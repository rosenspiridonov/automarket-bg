...
public class ListingNormalizer
{
    ...
    private static readonly Dictionary<string, string> FeatureAliases = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Безключово палене"] = "Keyless вход",
        ...
        ["Auto Start Stop function"] = "Старт-стоп система",

        // Mobile.bg long Bulgarian phrases → canonical abbreviated DB names
        ["Антиблокираща система"] = "ABS",
        ["Електронна програма за стабилизиране"] = "ESP",
        ["Система за динамична устойчивост"] = "ESP",
        ["Ел. разпределяне на спирачното усилие"] = "EBD",
        ["Ел.разпределяне на спирачното усилие"] = "EBD",
        ["Система за защита от пробуксуване"] = "ASR",
        ["Тракшън контрол"] = "ASR",
        ["Система за контрол на спускането"] = "Hill descent control",
        ["Адаптивни предни светлини"] = "Адаптивни фарове",
        ["Система ISOFIX"] = "ISOFIX",
        ["Bluetooth \\ handsfree система"] = "Bluetooth",
        ["Bluetooth / handsfree система"] = "Bluetooth",
        ["Блокаж на диференциала"] = "Diff lock",
        ["Ел. регулиране на седалките"] = "Електрически седалки",
        ["Ел.регулиране на седалките"] = "Електрически седалки",
        ["Ел. седалки"] = "Електрически седалки",
        ["Ел.седалки"] = "Електрически седалки",
        ["Отопление на волана"] = "Подгрев на волана",
        ["Подгряване на седалките"] = "Подгряване на седалки",
        ["Лети джанти"] = "Алуминиеви джанти",

        // Mobile.bg airbag variants → canonical DB names
        ["Airbag"] = "Въздушни възглавници",
        ["Въздушни възглавници - Предни"] = "Въздушни възглавници",
        ["Въздушни възглавници - Задни"] = "Въздушни възглавници",
        ["Въздушни възглавници - Странични"] = "Странични въздушни възглавници",

        // Cruise-control family
        ["Автопилот"] = "Адаптивен круиз контрол",
        ["Система за контрол на дистанцията"] = "Адаптивен круиз контрол",
        ["Система за контрол на скоростта (автопилот)"] = "Круиз контрол",

        // Sensor-driven comforts → DB names of the actual feature triggered
        ["Сензор за дъжд"] = "Автоматични чистачки",
        ["Датчик за светлина"] = "Автоматични фарове",
        ["Адаптивно въздушно окачване"] = "Air suspension",

        // Power-steering variants → DB's electric-power-steering entry
        ["Серво управление"] = "Електроусилвател на волана",
        ["Серво усилвател на волана"] = "Електроусилвател на волана",
        ["Ел. усилвател на волана"] = "Електроусилвател на волана",
        ["Ел.усилвател на волана"] = "Електроусилвател на волана",

        // Spelling and semantic variants
        ["Бордови компютър"] = "Бордкомпютър",
        ["Панорамен люк"] = "Панорамен покрив",
        ["Напълно обслужен"] = "Сервизна история",
    };
