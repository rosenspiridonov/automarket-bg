        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VinNumber = table.Column<string>(type: "character varying(17)", maxLength: 17, nullable: true),
                    ExternalSourceId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ExternalSourceUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarListings_Makes_MakeId",
                        column: x => x.MakeId,
                        principalTable: "Makes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarListingFeatures", x => new { x.FeaturesId, x.ListingsId });
                    table.ForeignKey(
                        name: "FK_CarListingFeatures_CarFeatures_FeaturesId",
                        column: x => x.FeaturesId,
                        principalTable: "CarFeatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarListingFeatures_CarListings_ListingsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favorites_CarListings_CarListingId",
                        column: x => x.CarListingId,
                        principalTable: "CarListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceHistories_CarListings_CarListingId",
                        column: x => x.CarListingId,
                        principalTable: "CarListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarListingFeatures_ListingsId",
                table: "CarListingFeatures",
                column: "ListingsId");

            migrationBuilder.CreateIndex(
                name: "IX_CarListings_CreatedAt",
                table: "CarListings",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_CarListings_Description",
                table: "CarListings",
                column: "Description")
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarListings_ExternalSourceId_ExternalSourceUrl",
                table: "CarListings",
                columns: new[] { "ExternalSourceId", "ExternalSourceUrl" });

            migrationBuilder.CreateIndex(
                name: "IX_CarListings_MakeId_ModelId_Year_Price",
                table: "CarListings",
                columns: new[] { "MakeId", "ModelId", "Year", "Price" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_CarListingId",
                table: "Favorites",
                column: "CarListingId");

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_CarListingId",
                table: "Favorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceHistories_CarListingId_RecordedAt",
                table: "PriceHistories",
                columns: new[] { "CarListingId", "RecordedAt" });
