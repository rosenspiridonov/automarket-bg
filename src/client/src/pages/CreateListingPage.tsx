  ...
  return (
    <Container size="md" className="py-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <FormSection
          title="Основни данни"
          description="Марка, модел, технически характеристики."
        >
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            >
              <Input
                ...
                placeholder="напр. BMW 320d M-Sport 2020"
                {...register("title")}
              />
            </Field>
        ...
        <FormSection
          ...
          description="Тези данни помагат на купувачите да те открият."
        >
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <Field
              className="md:col-span-2"
              label="Описание"
              hint="Опиши автомобила, неговото състояние и всичко важно."
            >
        ...
        <FormSection
          title="Снимки"
          description="До 20 снимки, JPG/PNG/WebP, до 10MB всяка."
        >
          <div
            {...getRootProps()}
            className={cn(
          ...
          >
            ...
            <p className="text-sm text-fg">
              {isDragActive
                ? "Пусни снимките тук..."
                : "Плъзни и пусни снимки или щракни за избор"}
            </p>
        ...
        {Object.keys(featuresByCategory).length > 0 && (
          <FormSection
            title="Екстри"
            description="Маркирай всичко, което автомобилът има."
          >
